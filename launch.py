...
gr.Interface(fn=classify_dino, inputs=image, outputs=label,examples=sample_images, capture_session=True, title=title, description=description).launch(debug=True,share=True)
